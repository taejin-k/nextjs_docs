...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      <div
        className="p-4"
        onClick={() => push("/linking-and-navigating/dashboard/setting")}
      >
        Setting Page router scroll true
      </div>
      <div className="p-4">12</div>
      <div
        className="p-4"
        onClick={() =>
          push("/linking-and-navigating/dashboard/setting", { scroll: false })
        }
      >
        Setting Page router scroll false
      </div>
      <div className="p-4">
        <Link href="/linking-and-navigating/dashboard/setting">
          Setting Page Link scroll true
        </Link>
      </div>
      <div className="p-4">15</div>
      <div className="p-4">16</div>
      <div className="p-4">
        <Link href="/linking-and-navigating/dashboard/setting" scroll={false}>
          Setting Page Link scroll false
        </Link>
      </div>
